import { ArrowRight, Shirt, Footprints, ShoppingBag, Gem } from 'lucide-react';
            ...
            return (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="font-serif text-2xl font-bold text-stone-900 group-hover:text-[#7c0f1e] transition-colors">
                      {cat.title}
                    </h3>

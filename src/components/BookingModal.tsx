...
export default function BookingModal({ isOpen, onClose }: BookingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        className="relative w-full max-w-lg bg-white border border-stone-200 rounded-2xl p-6 sm:p-8 shadow-2xl"
      ...
      >
        ...
        {isSuccess ? (
          <div className="py-8 text-center space-y-3">
            ...
            <h4 className="font-serif text-xl font-bold text-stone-900">Session Requested!</h4>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-stone-50 border border-stone-300 text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:border-[#7c0f1e]"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-stone-50 border border-stone-300 text-sm text-stone-900 focus:outline-none focus:border-[#7c0f1e] cursor-pointer font-medium"
                >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-stone-50 border border-stone-300 text-sm text-stone-900 focus:outline-none focus:border-[#7c0f1e]"
              />
            </div>
            ...
            <div className="flex flex-col gap-2 pt-2">
              <button
                type="submit"
                className="w-full py-3 rounded-xl text-xs sm:text-sm font-bold uppercase tracking-wider text-white bg-[#7c0f1e] hover:bg-[#911223] shadow-md transition-all"
              >
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider text-white bg-emerald-600 hover:bg-emerald-700 transition-colors flex items-center justify-center gap-1.5 shadow-sm"
              >
